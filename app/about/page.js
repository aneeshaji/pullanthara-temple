                                        ...
                                        <div className="about-content">
                                            <div className="section-title">
                                                ...
                                                <h2 className="wow fadeInUp" data-wow-delay=".3s">
                                                    Ganapathy is the leader of the Ganas
                                                </h2>
                                            </div>
                            ...
                            <div className="row">
                                <div className="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".3s">
                                    <div className="single-team-items">
                                        ...
                                        <div className="team-content text-center">
                                            <h3>
                                                <Link href="/team-details">K S Shivarajan</Link>
                                            </h3>
                                            <p>President</p>
                                        </div>
                                    </div>
                                ...
                                <div className="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".5s">
                                    <div className="single-team-items">
                                        ...
                                        <div className="team-content text-center">
                                            <h3>
                                                <Link href="/team-details">Sukhalal S</Link>
                                            </h3>
                                            <p>Secretaryr</p>
                                        </div>
                                    </div>
                                ...
                                <div className="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".7s">
                                    <div className="single-team-items">
                                        ...
                                        <div className="team-content text-center">
                                            <h3>
                                                <Link href="/team-details">Unni U</Link>
                                            </h3>
                                            <p>Tresurer</p>
                                        </div>
                                    </div>
                                ...
                                <div className="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".9s">
                                    <div className="single-team-items">
                                        ...
                                        <div className="team-content text-center">
                                            <h3>
                                                <Link href="/team-details">B Unnikrisnan</Link>
                                            </h3>
                                            <p>Kshesthram Thanthri</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
