                    ...
                    <div className="row g-4 align-items-center">
                        <div className="col-lg-8">
                            <div className="hero-content">
                                ...
                                Pullanthara Sree Maha Ganapathy Temple is one of the famous temples in south india with great historical importance. <br />
                                </p>
                        ...
                        <div className="col-lg-4">
                            <div className="hero-image wow fadeInUp" data-wow-delay=".4s">
                                <img src="/assets/img/home/1.png" alt="hero-img" />
                            </div>
                        </div>
                    </div>
                </div>
