                                ...
                                <SwiperSlide>
                                    <div className="service-box-items">
                                        ...
                                        <div className="content">
                                            ...
                                            <p>
                                                Lord Vinayaka's birthday falls on the chathurthi day
                                            </p>
                                ...
                                <SwiperSlide>
                                    <div className="service-box-items">
                                        ...
                                        <div className="content">
                                            ...
                                            <p>
                                               Festival starts on Vrishchikam 1 of every year.
                                            </p>
                                            {/* <Link href="/service-details" className="theme-btn-2 mt-3">
                                                read More
                                                <i className="fa-solid fa-arrow-right-long" />
                                ...
                                <SwiperSlide>
                                    <div className="service-box-items">
                                        ...
                                        <div className="content">
                                            ...
                                            <p>
                                            Navarathri is a festival 9 day festival celebrated by Hindus worldwide
                                            </p>
                                            {/* <Link href="/service-details" className="theme-btn-2 mt-3">
                                                read More
                                                <i className="fa-solid fa-arrow-right-long" />
                                ...
                                <SwiperSlide>
                                    <div className="service-box-items">
                                        ...
                                        <div className="content">
                                            ...
                                            <p>
                                                Vishu is a Hindu festival primarily celebrated in the Indian state of Kerala
                                            </p>
                                            {/* <Link href="/service-details" className="theme-btn-2 mt-3">
                                                read More
                                                <i className="fa-solid fa-arrow-right-long" />
